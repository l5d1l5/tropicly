	...
	\subsection{Deforestation} 
		...
		%TODO mention your definition of ppd classes, goes after haversine equation
			...
			\label{eq:haversine_function}
				...
				\right)
			\end{equation}
			We aggregated our results on \acp{PDD} for country, continental and global scale by using the administrative bounds of the natural earth layer. To present our results as maps for the three continental regions we developed our own visualization approach that is explained in section \ref{subsec:methods_binning}.
