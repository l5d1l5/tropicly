...
\section{Methods}
\label{sec:methods}
	%TODO references for shapely, fiona, geopandas, javascript, jupyter, affine, r, dia, gimp, bash, gdal, papaparse, google map api, gimp, dia
