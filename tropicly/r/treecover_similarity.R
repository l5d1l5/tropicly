...
jc_africa = read.csv('/home/tobi/Documents/tropicly/data/proc/ana/harmonization_africa.csv')
africa = jc_africa[jc_africa[,1]!=0,]
africa = africa[,1:4]
#cor(africa[,1:4])
summary(africa[,1:4])

jc_asia = read.csv('/home/tobi/Documents/tropicly/data/proc/ana/harmonization_asia.csv')
