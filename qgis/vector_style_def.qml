...
<qgis version="2.14.11-Essen" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="label" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="10" label="cultivated"/>
      <category render="true" symbol="1" value="20" label="forest"/>
      <category render="true" symbol="2" value="25" label="regrowth"/>
      <category render="true" symbol="3" value="30" label="grass"/>
      <category render="true" symbol="4" value="40" label="shrub"/>
      <category render="true" symbol="5" value="50" label="wet"/>
      <category render="true" symbol="6" value="60" label="water"/>
      <category render="true" symbol="7" value="70" label="tundra"/>
      <category render="true" symbol="8" value="80" label="artificial"/>
      <category render="true" symbol="9" value="90" label="bare"/>
      <category render="true" symbol="10" value="100" label="snow"/>
    </categories>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="249,160,255,255"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="10">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="198,239,255,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
